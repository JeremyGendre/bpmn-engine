import {
  BoundaryEventAttributes,
  EndEventAttributes,
  ExclusiveGatewayAttributes,
  ProcessAttributes,
  SequenceFlowAttributes,
  ServiceTaskAttributes,
  StartEventAttributes,
  UserTaskAttributes,
} from "./attributes";
import {
  ArrayOrSingle,
...
export interface StartEvent
  extends OutgoingFlow,
    WithAttributes<StartEventAttributes> {}
export interface EndEvent
  extends IncomingFlows,
    WithAttributes<EndEventAttributes> {}
export interface UserTask
  extends OutgoingFlow,
    IncomingFlows,
    WithAttributes<UserTaskAttributes> {}
export interface ServiceTask
  extends OutgoingFlow,
    IncomingFlows,
    WithAttributes<ServiceTaskAttributes> {}
export interface ExclusiveGateway
  extends OutgoingFlows,
    IncomingFlows,
    WithAttributes<ExclusiveGatewayAttributes> {}
export interface BoundaryEvent
  extends OutgoingFlow,
    WithAttributes<BoundaryEventAttributes> {}
...
export type TypedElements = Record<
  string,
  | TypedStartEvent
  | TypedEndEvent
  | TypedSequenceFlow
